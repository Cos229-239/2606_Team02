...
Assert-FileContains $state "First Trade"
Assert-FileContains $state "Awaken the Roots"
Assert-FileContains $state "First Forging"
...
Assert-FileContains $village "QuestReadyBadge"
...
Assert-FileContains $panel "ScrollContainer"
